...
public class LinkedAccountsFragment extends Fragment {
    ...
    public void setLinkedAccounts(){
        ...
        LinearLayout linkedAccountsContainer = (LinearLayout) rootView.findViewById(R.id.linkedAccountsContainer);
        ...
        for(LinkedAccount la : linkedAccounts){
            ...
            LinearLayout linkedAccountElement = new LinearLayout(context);
            ...
            ImageView accountProviderIcon = new ImageView(context);
            ...
            LinearLayout accountDetailsContainer = new LinearLayout(context);
            ...
            TextView accountID = new TextView(context);
            ...
            Button editButton = new Button(context, null, android.R.attr.borderlessButtonStyle);
            ...
            Button removeButton = new Button(context, null, android.R.attr.borderlessButtonStyle);
            ...
            ToggleButton displayInCalToggle = new ToggleButton(context);
        ...
        LinearLayout addAccountElement = new LinearLayout(context);
        ...
        //Set the image
        ImageView addAccountIcon = new ImageView(context);
        ...
        TextView addAccountMessage = new TextView(context);
